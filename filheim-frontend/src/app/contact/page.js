            ...
            <section className='px-4 py-16'>
                <div className='max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-start'>
                    <form
                        ...
                        className='bg-white text-[#2f2f2f] p-8 rounded-xl space-y-6 shadow-xl transition-transform duration-500 hover:scale-[1.02]'
                    >
                        <h2
                            className='text-2xl font-bold mb-4 text-[#b0984b] uppercase'
                    ...
                    <div className='animate-fade-in delay-300'>
                        <h2
                            className='text-2xl font-semibold mb-4 text-[#b0984b]'
                            style={{ fontFamily: "'Inter', sans-serif" }}
                        >
                            Showroom Map
                        </h2>
