...
function ServicesCraftmanship({ asideImage }) {
    return (
        <section
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
                            ...
                            <div className='flex flex-col'>
                                <div>
                                    ...
                                    >
                                        Precision-crafted using time-tested
                                        techniques, where traditional
                                        woodworking meets modern engineering.
                                        Every detail—from joint to finish—is
                                        perfected for enduring beauty and
                                        strength.
                                    </p>
                                </div>
